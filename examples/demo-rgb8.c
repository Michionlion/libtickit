...
static int on_expose(TickitWindow *win, TickitEventFlags flags, void *_info, void *data) {
    ...
    for (int x = 0; x < cols; x++) {
        ...
        tickit_pen_set_colour_attr_rgb8(
            pen, TICKIT_PEN_BG, (TickitPenRGB8){.r = 255 * x / (cols - 1), .g = 0, .b = 0});
    ...
    for (int x = 0; x < cols; x++) {
        ...
        tickit_pen_set_colour_attr_rgb8(
            pen, TICKIT_PEN_BG, (TickitPenRGB8){.r = 0, .g = 255 * x / (cols - 1), .b = 0});
    ...
    for (int x = 0; x < cols; x++) {
        ...
        tickit_pen_set_colour_attr_rgb8(
            pen, TICKIT_PEN_BG, (TickitPenRGB8){.r = 0, .g = 0, .b = 255 * x / (cols - 1)});
