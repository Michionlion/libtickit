...
static bool mtd_scrollrect(
    TickitTermDriver *ttd, const TickitRect *rect, int downward, int rightward) {
    MockTermDriver *mtd = (MockTermDriver *)ttd;
...
void tickit_mockterm_destroy(TickitMockTerm *mt) { tickit_term_destroy((TickitTerm *)mt); }
