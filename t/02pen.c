...
int main(int argc, char *argv[]) {
    ...
    is_int(
        tickit_pen_attrtype(TICKIT_PEN_BOLD), TICKIT_PENTYPE_BOOL, "bold is a boolean attribute");
    ...
    ok(!tickit_pen_nondefault_attr(pen, TICKIT_PEN_BOLD),
        "pen bold attr is default after set bold off");
    ...
    is_int(tickit_pen_attrtype(TICKIT_PEN_FG), TICKIT_PENTYPE_COLOUR,
        "foreground is a colour attribute");
    ...
    ok(tickit_pen_set_colour_attr_desc(pen, TICKIT_PEN_FG, "hi-red"),
        "pen set foreground 'hi-red'");
    is_int(
        tickit_pen_get_colour_attr(pen, TICKIT_PEN_FG), 8 + 1, "foreground 8+1 after set 'hi-red'");
    ...
    ok(tickit_pen_equiv_attr(pen, pen2, TICKIT_PEN_BOLD),
        "pens have equiv bold attribute initially");

    tickit_pen_set_bool_attr(pen, TICKIT_PEN_BOLD, 1);

    ok(!tickit_pen_equiv_attr(pen, pen2, TICKIT_PEN_BOLD),
        "pens have unequiv bold attribute after set");
    ...
    ok(tickit_pen_equiv_attr(pen, pen2, TICKIT_PEN_ITALIC),
        "pens have equiv italic attribute after set 0");

    tickit_pen_copy_attr(pen2, pen, TICKIT_PEN_BOLD);
    ok(tickit_pen_equiv_attr(pen, pen2, TICKIT_PEN_BOLD),
        "pens have equiv bold attribute after copy attr");

    tickit_pen_clear_attr(pen2, TICKIT_PEN_BOLD);
    tickit_pen_copy(pen2, pen, 1);

    ok(tickit_pen_equiv_attr(pen, pen2, TICKIT_PEN_BOLD),
        "pens have equiv bold attribute after copy");

    tickit_pen_set_bool_attr(pen2, TICKIT_PEN_BOLD, 0);
    tickit_pen_copy(pen2, pen, 0);

    ok(!tickit_pen_equiv_attr(pen, pen2, TICKIT_PEN_BOLD),
        "pens have non-equiv bold attribute after copy no overwrite");

    tickit_pen_set_int_attr(pen, TICKIT_PEN_UNDER, TICKIT_PEN_UNDER_NONE);
    tickit_pen_clear_attr(pen2, TICKIT_PEN_UNDER);
    tickit_pen_copy(pen2, pen, 1);

    ok(tickit_pen_has_attr(pen2, TICKIT_PEN_UNDER),
        "pen copy still copies present but default-value attributes");
    ...
    // RGB8 secondary colour attributes
    {
        ...
        ok(!tickit_pen_has_colour_attr_rgb8(pen, TICKIT_PEN_FG), "new pen does not have FG RGB8");
