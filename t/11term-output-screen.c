...
int main(int argc, char *argv[]) {
    ...
    is_str_escape(buffer, "\e[4;10r\e[4;1H\e[M\e[1;24r",
        "buffer after tickit_term_scrollrect lines 3-9 1 down");

    buffer[0] = 0;
    tickit_term_scrollrect(tt, RECT(3, 0, 15, 80), 8, 0);
    is_str_escape(buffer, "\e[4;18r\e[4;1H\e[8M\e[1;24r",
        "buffer after tickit_term_scrollrect lines 3-17 8 down");

    buffer[0] = 0;
    tickit_term_scrollrect(tt, RECT(3, 0, 7, 80), -1, 0);
    is_str_escape(buffer, "\e[4;10r\e[4;1H\e[L\e[1;24r",
        "buffer after tickit_term_scrollrect lines 3-9 1 up");

    buffer[0] = 0;
    tickit_term_scrollrect(tt, RECT(3, 0, 15, 80), -8, 0);
    is_str_escape(buffer, "\e[4;18r\e[4;1H\e[8L\e[1;24r",
        "buffer after tickit_term_scrollrect lines 3-17 8 up");
