...
int main(int argc, char *argv[]) {
    ...
    // scroll down
    {
        ...
        is_termlog("Termlog after fullwidth scroll downward", SETPEN(),
            SCROLLRECT(5, 0, 10, 80, 1, 0), NULL);
    ...
    // scroll up
    {
        ...
        is_termlog("Termlog after fullwidth scroll upward", SETPEN(),
            SCROLLRECT(5, 0, 10, 80, -1, 0), NULL);
    ...
    // scroll right
    {
        ...
        is_termlog("Termlog after fullwidth scroll rightward", SETPEN(),
            SCROLLRECT(5, 0, 10, 80, 0, 1), NULL);
    ...
    // scroll left
    {
        ...
        is_termlog("Termlog after fullwidth scroll leftward", SETPEN(),
            SCROLLRECT(5, 0, 10, 80, 0, -1), NULL);
    ...
    {
        next_rect = 0;
        ok(tickit_window_scrollrect(
               win, &(TickitRect){.top = 2, .left = 0, .lines = 3, .cols = 80}, -1, 0, NULL),
            "Fullwidth window supports scrolling a region");
        tickit_window_flush(root);

        is_termlog("Termlog after fullwidth scrollrect downward", SETPEN(),
            SCROLLRECT(7, 0, 3, 80, -1, 0), NULL);
    ...
    // scrollrect down
    {
        ...
        is_termlog("Termlog after fullwidth scrollrect upward", SETPEN(),
            SCROLLRECT(7, 0, 3, 80, 1, 0), NULL);
    ...
    // scrollrect further than area just exposes
    {
        next_rect = 0;
        tickit_window_scrollrect(
            win, &(TickitRect){.top = 2, .left = 0, .lines = 3, .cols = 80}, 5, 0, NULL);
        tickit_window_flush(root);

        is_termlog("Termlog empty after scrollrect further than area", NULL);
    ...
    // scrollrect with pending damage
    {
        ...
        next_rect = 0;
        tickit_window_scrollrect(
            win, &(TickitRect){.top = 4, .left = 0, .lines = 6, .cols = 80}, 2, 0, NULL);
        tickit_window_flush(root);

        is_termlog("Termlog after scrollrect with impending damage", SETPEN(),
            SCROLLRECT(9, 0, 6, 80, 2, 0), NULL);
    ...
    // Child to obscure part of it
    {
        ...
        is_termlog("Termlog after scroll with obscuring child", SETPEN(),
            SCROLLRECT(5, 10, 3, 70, 0, 4), SCROLLRECT(8, 0, 7, 80, 0, 4), NULL);
        ...
        is_termlog("Termlog after scroll with hidden obscuring child", SETPEN(),
            SCROLLRECT(5, 0, 10, 80, 0, 4), NULL);
    ...
    // scroll_with_children
    {
        ...
        is_termlog(
            "Termlog after scroll_with_children", SETPEN(), SCROLLRECT(5, 0, 10, 80, -2, 0), NULL);
    ...
    // sibling to obscure part of it
    {
        ...
        is_termlog("Termlog after scroll_with_children with sibling", SETPEN(),
            SCROLLRECT(10, 0, 5, 80, -2, 0), NULL);
        ...
        is_termlog("Termlog after scroll_with_children with hidden sibling", SETPEN(),
            SCROLLRECT(5, 0, 10, 80, -2, 0), NULL);
    ...
    // Hidden windows should be ignored
    {
        ...
        is_termlog("Termlog empty after scroll on hidden window", NULL);
    }
